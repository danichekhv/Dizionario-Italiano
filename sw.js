...
const SHELL = ['/', '/index.html', '/styles.css', '/app.js', '/it-words.txt', '/cards.js', '/graph.js', '/auth.js', '/pratica.js', '/grammatica.js', '/qa.js', '/manifest.json', '/icon-192.png', '/icon-512.png'];
